...
rem   directory.
rem
call src_get_ins_aspic pic cmdusb
call src_get_ins_aspic pic cmdusb_setup
call src_get_ins_aspic pic fwtype
call src_get_ins_aspic pic name
call src_get_ins_aspic pic port
call src_get_ins_aspic pic prom_setup
...
call src_get_ins_aspic %srcdir% %fwname%_cmdrsp
